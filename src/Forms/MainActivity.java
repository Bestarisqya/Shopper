...
public class  MainActivity extends JFrame {
    ...
    private void setStokPanel() throws IOException{
        ...
        ArrayList<Shopperr> _listItem = getProductData();
    ...
    private ArrayList<Shopperr> getProductData() throws IOException {
        ...
        ArrayList<Shopperr> productList = new ArrayList<>();
        for (int index = 0; index<productsJSONArray.length();index++){
            Shopperr productsModel = new Shopperr();
